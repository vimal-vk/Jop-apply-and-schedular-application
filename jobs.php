...
<body>
  ...
  <div class="container">
    <?php
      ...
      echo "<h3>Ongoing Registrations</h3>";
      $query="select * from job where reg_start_date<'$date' and reg_end_date>'$date'";
      ...
      $count=1;
      echo "<h3>Upcoming Registrations</h3>";
      $query="select * from job where reg_start_date>'$date'";
      $res = mysqli_query($connect,$query);
      $count=1;
      while($row = $res->fetch_assoc()){
        if(($count-1)%3==0){
